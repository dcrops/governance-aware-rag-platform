...
def main():
    parser = argparse.ArgumentParser(description="Ask a question against an indexed client RAG collection.")
    parser.add_argument("--question", required=True, help="Question to ask the client knowledge base.")
    parser.add_argument("--client", default="demo_client", help="Client name / collection suffix.")
    ...
    # Initialize VectorStore for existing collection
    vector_store = VectorStore(
        persist_dir=persist_dir,
        collection_name=collection_name
    )

    # Probe if collection exists and is nonempty
    try:
    ...
    # Use the "rule"-based QueryRewriter
